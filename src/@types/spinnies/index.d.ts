declare module 'spinnies' {
  ...
  declare class Spinnies {
     ...
     */
    add: (name: string, options?: Spinnies.SpinnerOptions) => Spinnies.SpinnerOptions;
     ...
     */
    update: (name: string, options?: Spinnies.SpinnerOptions) => Spinnies.SpinnerOptions;

    /**
     * Sets the specified spinner status as succeed.
     */
    succeed: (name: string, options?: Spinnies.SpinnerOptions) => Spinnies.SpinnerOptions;

    /**
     * Sets the specified spinner status as fail.
     */
    fail: (name: string, options?: Spinnies.SpinnerOptions) => Spinnies.SpinnerOptions;
